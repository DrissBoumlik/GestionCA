...
class StatsImport implements ToModel, WithHeadingRow
{
    ...
    {
//        dump($row['dimension_notestype_note'], $row['dimension_notesutilisateur'], $row['dimension_notescode_postal_site']);
        $x = new Stats([
            ...
            'Date_Création' => $row['dimension_notesdate_creation'],
...
//                    'Departement' => $row['dimension_noteDepartement'],
            ...
            'Gpmt_Appel_Pré' => $row['dimension_notesgpmt_appel_pre'],
