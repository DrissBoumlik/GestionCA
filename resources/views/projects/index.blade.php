        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <div class="flex-sm-fill">
                    <h1 class="h3 my-2 d-inline-block">Projects</h1>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-left">Add Projects</h3>
                        <a href="#" class="link btn btn-primary mgl-10 round add-project" data-target='#projectForm' data-toggle='modal' title="Add User"><i
                                class="fas fa-plus"></i></a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-responsive">
                        <table id="projects-data"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="header-form">Add / Edit Project</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="select2-wrapper">
                                    <select name="collaborators[]" id="collaborators" class="w-100"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-primary full-w update-project">
...
@section('js_after')
    ...
    <script src="{{ asset("/add_ons/projects/datatable.js") }}"></script>
    <!-- Alert -->
