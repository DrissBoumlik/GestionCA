...
@section('js_after')
    ...
    <script src="{{ asset("/add_ons/stats/details/appels_gem/stats.js") }}"></script>
    <script>
        $(function () {
            @if($errors->any())
            swal(
    ...
    <div class="content content-narrow">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title d-inline-block">Résultats Appels GEM</h3>
                            <hr>
                ...
                <!-- /.col -->
                <div class="col-12">
                    <canvas id="statsCallsGemChart" class=""></canvas>
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
