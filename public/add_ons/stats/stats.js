$(function () {
    ...
    $("#printElement").on("click", function () {
        ...
        doc.autoTable({html: '#statsCallsPos', margin: {left: 0, top: 30}, pageBreak: 'auto', tableWidth :841.89});
        ...
        doc.autoTable({html: '#statsCallsNeg', margin: {left: 0, top: 30}, pageBreak: 'auto',tableWidth :841.89});
        doc.addImage(statscallsNegChartImg, 'JPEG',150,($('#statsCallsNeg').height()/1.328147) + 30  , 500 , 250);
        doc.addPage();
