$(function () {
    ...
    $("#printElement").on("click", function () {
        ...
        doc.autoTable({html: '#statsRegions', margin: {left: 0 , top: 30}, pageBreak: 'auto', tableWidth: 520});
        doc.addImage(statsRegionsChartImg, 'JPEG', 532 , 30 , 350 , 300);
        doc.text(10, 390, 'Répartition des dossiers traités par périmètre');
        doc.autoTable({html: '#statsFolders', pageBreak: 'auto', tableWidth: 520, startY: 400, margin: {left: 0} });
        doc.addImage(statsFoldersChartImg, 'JPEG', 532, 400  , 350 , 350);
        doc.addPage();
        doc.text(10, 20, 'Résultats Appels Préalables par agence');
        doc.autoTable({html: '#callsStatesAgencies', margin: {left: 0 , top: 30}, pageBreak: 'auto', tableWidth: 520});
        ...
        doc.autoTable({html: '#statsFoldersByType', margin: {left: 0 , top: 30}, pageBreak: 'auto',styles: {cellPadding: {top: 0, bottom: 0}}, tableWidth: 525 });
        doc.addPage();
        ...
        doc.autoTable({html: '#statsFoldersByCode', margin: {left: 0 , top: 30}, pageBreak: 'auto',styles: {cellPadding: {top: 0, bottom: 0}} , tableWidth: 525});
        doc.addPage();
