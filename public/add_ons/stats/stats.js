$(function () {
    ...
    $("#printElement").on("click", function () {
        ...
        doc.autoTable({html: '#statsFoldersByType', margin: {left: 0 , top: 30}, pageBreak: 'auto', tableWidth: 520,styles: {cellPadding: {top: 0, bottom: 0}}});
        doc.addPage();
        ...
        doc.autoTable({html: '#statsFoldersByCode', margin: {left: 0 , top: 30}, pageBreak: 'auto', tableWidth: 520,styles: {cellPadding: {top: 0, bottom: 0}}});
        doc.addPage();
