$(function () {
    ...
    $("#printElement").on("click", function () {
        ...
        doc.autoTable({html: '#statsCallsPrealable', margin: {left: 0 , top: 50}, pageBreak: 'auto', tableWidth: 520 ,styles: {fontSize: 7}});
        doc.addImage(statsRegionsChartImg, 'JPEG',  532 , 30 , 350 , 300);
        doc.addPage();
        doc.text(10, 20, 'Résultats Appels Préalables par agence');
        doc.autoTable({html: '#callsStatesAgencies', margin: {left: 0 , top: 30}, pageBreak: 'auto', tableWidth: 520 ,styles: {cellPadding: {top: 10, bottom: 10,right : 0} ,fontSize: 7} });
