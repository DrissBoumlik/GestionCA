$(function () {
    ...
    $('#refreshFoldersByType').on('click', function () {
        getColumns(statsFoldersByType, true, false, filterData(), {refreshMode: true});
    });
    ...
    $('#refreshFoldersByCode').on('click', function () {
        getColumns(statsFoldersByCode, true, false, filterData(), {refreshMode: true});
    });
    //</editor-fold>
    ...
    $("#refreshAll").on('click', function () {
        getColumns(statsCallsCloture, true, true, filterData(), {
            removeTotal: false,
            refreshMode: false,
            removeTotalColumn: false
        });
